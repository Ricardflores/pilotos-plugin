<?php
if (!function_exists( 'ejercicios_post_type' )){
    function ejercicios_post_type() {

        $labels = array(
            'name'                  => _x( 'ejercicio', 'Post Type General Name', 'primerapagina' ),
            'singular_name'         => _x( 'ejercicio', 'Post Type Singular Name', 'primerapagina' ),
            'menu_name'             => __( 'ejercicios', 'primerapagina' ),
            'name_admin_bar'        => __( 'ejercicio', 'primerapagina' ),
            ...
            'all_items'             => __( 'Todos los ejercicios', 'primerapagina' ),
            'add_new_item'          => __( 'Agregar un nuevo ejercicio', 'primerapagina' ),
        ...
        register_post_type( 'ejercicios', $args );
    
    }
    add_action( 'init', 'ejercicios_post_type', 0 );
}
